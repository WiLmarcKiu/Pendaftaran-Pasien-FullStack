                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                    $dataPegawai = $koneksi->query("SELECT * FROM pegawai WHERE id_pegawai = '$id_pegawai'");
                                    $detail = $dataPegawai->fetch_assoc();
                                    ?>
                                            ...
                                            <table class="table noborder table-hover">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td><?php echo $detail['gol_pegawai']; ?> / <?php echo $detail['pangkat']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Status Kawin</td>
                                                        <td>:</td>
                                                        <td><?php echo $detail['status_kawin']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Jabatan</td>
                                                        <td>:</td>
